  ...
  <body>  
    <div class="card" style="width:100%;" id="MAN"> 
        ...
        <div class="list-group"> 
            ...
            <a href="orderlist.jsp" class="list-group-item list-group-item-action alone">Order List</a>
    ...
    <div class="button-wrapper" style="flex-basis: 70rem;" id="cd2">   
        ...
        <div class="bd"> 
            <table class="table table-striped table-striped" id="tbl"> 
              <thead>
                <tr>
...
String sql ="select * from delievery"; 
int count=1;
...
<td class="text-center"><a href="showorderdetail.jsp?b=<%=resultSet.getString("dateandtime")%>"><button type="button" class="btn btn-primary" >Show Details</button></a></td>
</tr>
<%
}
connection.close();
