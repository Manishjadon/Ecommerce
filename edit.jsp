...
%>
<tr>  
<td>First Name :</td><td><input type="text" value=<%=resultSet.getString("firstname") %> name="first"></td> 
</tr>
<tr>
<td>Last Name :</td><td><input type="text" value=<%=resultSet.getString("lastname") %> name="last"></td> 
</tr>
<tr>
<td>User Name :</td><td><input type="text" value=<%=resultSet.getString("username") %> name="user"></td> 
</tr>
<tr>
<td>Password :</td><td><input value=<%=resultSet.getString("password") %> name="pass"> <input type=hidden  value=<%=id %> name="b"></td>   
</tr>  
<%
}
connection.close();
...
%>  
              ...
              <button class="btn btn-secondary" type="submit" style="min-widt:8rem;">Edit</button>
              </form>
        </div>
    </div >
    <!-- Optional JavaScript -->
