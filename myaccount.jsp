...
String ctg=request.getParameter("b");
try {
...
while(resultSet.next()){
%>  <tr> 
<th rowspan="4" colspan="3" ><img src="<%=resultSet.getString("imgsrc") %>"  width="50%" style="border-radius:50%;"></th>  
<td><B>First Name&nbsp;&nbsp;&nbsp;&nbsp;:</B></td><td><B><%=resultSet.getString("firstname") %></B></td>  
</tr>
<tr>
<td><B>Last Name&nbsp;&nbsp;&nbsp;&nbsp;:</B></td><td><B><%=resultSet.getString("lastname") %></B></td>  
</tr>
<tr>
<td><B>Username&nbsp;&nbsp;&nbsp;&nbsp;:</B></td><td><B><%=resultSet.getString("username") %></B></td> 
</tr>   
<tr>
<td><B>Password&nbsp;&nbsp;&nbsp;&nbsp;:</B></td><td><B><%=resultSet.getString("password") %></B></td> 
</tr>  
<tr>
<th colspan="3"> 
<form action="addphoto.jsp">
<input type="file" id="myfile" style="display:none;" name="pic"/>
<button type="submit" onclick="document.getElementById('myfile').click();" style="margin-left:3.5rem;" class="btn-secondary">Upload</button> 
</form>
</th>
<td colspan="2"><a href="editaccount.jsp?b=<%=id %>"><button type="submit" class="btn-success" style="margin-left:4rem;">Edit Details</button></a></td>
</tr>
<%
}
connection.close();
